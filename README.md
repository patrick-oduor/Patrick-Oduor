...
* **Core Tech:** Next.js 15+, MongoDB, Twilio SMS.
* **Key Innovation:** Integrated M-Pesa STK Push reconciliation, revenue intelligence tracking, and forensic audit logging.
* **Security:** SMS-based identity recovery with infrastructure-level rate limiting.

### [Serene Oasis](https://github.com/patrick-oduor/serene-oasis)
**Luxury Wellness CRM designed as a self-sustaining acquisition engine.**
* **Core Tech:** Next.js 15+, SendGrid API, MongoDB.
* **Key Innovation:** Proprietary **Tier Evolution Metric** for automated retention and a viral "Gift-to-Acquisition" loop.
* **Security:** Custom RBAC middleware for strict management/client data isolation.
